...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 0.684, -2.79), -- Position of the thrust application point relative to the CoG
        ...
        thrustMultiplier = 2.5,                           -- Multiplier on turbine output thrust
