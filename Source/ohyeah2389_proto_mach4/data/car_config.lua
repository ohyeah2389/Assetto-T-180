...
local config = {
    ...
    turbojet = {
        ...
        helperStartAngle = 90, -- Angle in degrees at which the turbojet starts to automatically apply throttle
        helperEndAngle = 180, -- Angle in degrees at which the turbojet ends automatically applying throttle
