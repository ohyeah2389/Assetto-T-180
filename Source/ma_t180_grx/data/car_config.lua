...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 1.2, -1.14), -- Position of the thrust application point relative to the CoG
        thrustAngle = 35, -- Angle in degrees at which the turbojet thrust is applied
        ...
        inertia = 0.08, -- Inertia of the turbine shaft
        minThrottle = 0.08, -- Idle throttle of the turbine
