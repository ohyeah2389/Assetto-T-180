...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 1.1, -1.6), -- Position of the thrust application point relative to the CoG
        thrustAngle = 45,                              -- Angle in degrees at which the turbojet thrust is applied
        ...
        frictionCoef = 0.06,                           -- Friction coefficient of the turbine shaft
        inertia = 0.15,                                -- Inertia of the turbine shaft
        minThrottle = 0.05,                            -- Idle throttle of the turbine
        throttleLag = 0.4,                             -- 0 to 1 where 0 represents instant turbine throttle response (unrealistic) and 1 represents no change in throttle
        throttleLagAfterburner = 0.4,                  -- 0 to 1 as above, but for afterburner fuel delivery
        thrustMultiplier = 3.25,                       -- Multiplier on turbine output thrust
