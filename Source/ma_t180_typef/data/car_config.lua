...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 0.4925, -2.29), -- Position of the thrust application point relative to the CoG
        ...
        thrustCurveLevel = 0.35,                           -- Level of thrust increase/decrease with speed: >0 increases thrust, <0 decreases thrust, 0 is neutral
