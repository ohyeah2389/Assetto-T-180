...
local config = {
    ...
    turbojet = {
        ...
        frictionCoef = 0.07,            -- Friction coefficient of the turbine shaft
        inertia = 0.18,                 -- Inertia of the turbine shaft
        minThrottle = 0.05,             -- Idle throttle of the turbine
        throttleLag = 0.55,             -- 0 to 1 where 0 represents instant turbine throttle response (unrealistic) and 1 represents no change in throttle
        throttleLagAfterburner = 0.55,  -- 0 to 1 as above, but for afterburner fuel delivery
        thrustMultiplier = 3.15,        -- Multiplier on turbine output thrust
