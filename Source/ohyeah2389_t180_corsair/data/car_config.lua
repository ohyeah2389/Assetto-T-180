...
local config = {
    ...
    turbojet = {
        ...
        frictionCoef = 0.14,            -- Friction coefficient of the turbine shaft
        inertia = 0.3,                  -- Inertia of the turbine shaft
        ...
        thrustMultiplier = 2.65,        -- Multiplier on turbine output thrust
