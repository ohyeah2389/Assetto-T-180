...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 0.9, -2.149), -- Position of the thrust application point relative to the CoG
        ...
        inertia = 0.16,                                  -- Inertia of the turbine shaft
        ...
        thrustMultiplier = 2.85,                         -- Multiplier on turbine output thrust
