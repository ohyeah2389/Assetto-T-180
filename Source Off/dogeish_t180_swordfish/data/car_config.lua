...
local config = {
    ...
    turbojet = {
        ...
        thrustApplicationPoint = vec3(0.0, 0.617, -2.1),
        ...
        thrustMultiplier = 2.8,         -- Multiplier on turbine output thrust
        ...
        boostSpeedFactor = 0.0005,      -- Multiplier on turbine angular speed to form bleed air boost speed component (thrust component is added to this for total bleed air boost value)
